    ...
    return (
        <div className='space-y-4 mt-2 rounded-md md:mx-15'>
            <div className='bg-gray-200 flex gap-7 items-center p-2 rounded-md'>
                <img src={product.image} alt={product.title} className='md:h-50 md:w-50 h-25 w-25 md:rounded-md rounded-full cursor-pointer' onClick={() => navigate(`/product/${product.id}`)} />
